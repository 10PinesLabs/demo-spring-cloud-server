...
public class RequestLoggingFilter extends OncePerRequestFilter {
  ...
  private static final Logger logger = LoggerFactory.getLogger("CONFIG_MESSAGES");

  private static final String REQUEST_PREFIX = "Request: ";
  private static final String RESPONSE_PREFIX = "Response: ";
  private static final String MDC_KEY = "CONFIG_REQUEST";
  ...
  private void logRequest(final HttpServletRequest request) {
    ...
    String canal = request.getHeader(Headers.HEADER_CANAL);
    if (canal != null && !canal.isEmpty()) {
      msg.append("canal:").append(canal).append(" ");
    }
